...
# IMPORTANT !!! -------------------------------------------------------------------------------
# dict keeps items in the same order they were introduced (insertion order) after Python 3.7
# ---------------------------------------------------------------------------------------------
...
print(".items() --> Loop through a dict's items, each item is a tuple, a tuple of key / value pair -----------------------")
